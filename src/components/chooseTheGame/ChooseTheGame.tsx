...
const ChooseTheGame: React.FC = () => {
  ...
  return (
    <div className={style.chooseLevel}>
      <NavLink to="/easy-level">
        <Button
          onClick={() => dispatch(gameAction.chooseLevel(25))}
          variant="outline-light"
        >
          25
        </Button>
      </NavLink>
      <NavLink to="/average-level">
        <Button
          onClick={() => dispatch(gameAction.chooseLevel(36))}
          variant="outline-light"
        >
          36
        </Button>
      </NavLink>
      <NavLink to="/hard-level">
        <Button
          onClick={() => dispatch(gameAction.chooseLevel(49))}
          variant="outline-light"
        >
          49
        </Button>
      </NavLink>
      <NavLink to="/impossible-level">
        <Button
          onClick={() => dispatch(gameAction.chooseLevel(81))}
          variant="outline-light"
        >
          81
        </Button>
