...
const { setFriendDragon, setAngryDragon } = chooseTheDragonAction;

const { setOpenCellsHacked, setOpenCells } = currentGameStatisticAction;

const { setFieldStatus, finishedGame, winnerGame, changeGameStatusControl } =
  gameAction;

const { setEng, setRus } = changeLangAction;

const { changeSoundVolume } = soundAction;
